...
const frontendShared = [
  ...
  'fetchSystemStatus', 'renderSystemStatus', 'initTwoFactorPanel',
  'renderTwoFactorPanel', 'twoFaSetup', 'twoFaEnable', 'twoFaDisable',
  'renderTwoFactorDisable', 'renderEmployeesTable',
