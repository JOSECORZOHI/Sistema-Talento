 ...
 * Equivalente server-side de `sanitize()` en public/utils.js (client-side).
 *
...
/**
 * Normaliza texto para búsquedas/comparaciones: minúsculas y sin tildes (NFD).
 * Equivalente server-side de `sanitize` no aplica; de XSS usa `escapeHtml`.
 *
