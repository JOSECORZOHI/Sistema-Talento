...
function getKey() {
  ...
  if (!jwtSecret || !jwtSecret.trim()) {
    throw new Error('No hay clave de cifrado: configure DOC_ENC_KEY (o, fuera de producción, JWT_SECRET).');
  }
...
module.exports = { encryptBuffer, decryptBuffer, genKey, assertEncryptionKey };
